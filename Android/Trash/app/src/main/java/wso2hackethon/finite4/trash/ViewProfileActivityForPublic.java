...
public class ViewProfileActivityForPublic extends Activity {
    Data data = new Data();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_profile_activity_for_public);
        context = ViewProfileActivityForPublic.this;
